...
public class LoginPage extends BasePage {
	...
	public LoginPage(AndroidDriverBase driver) {// 需要默认添加一个构造方法
		super(driver);
	 ...
	 * 点击手机号码登陆   老用户登录
	 */
	public void benJiLogin() throws Exception {
...
//		//点击下一步
//		//选择男女
//		//选择男  android.widget.ImageView   android.widget.ImageView
//		//android.view.View 点击下一步
//		//点击选择日期
//		//点击选择下一步  android.view.View
//		//是否输入验证码   android.view.View
//		//欢迎页面？  欢迎页面
	...
	public boolean loginCheck() throws Exception {
		boolean flag = false;// 默认是没有登录框
			...
			if (driver.isExitCurActivity("com.reactnativenavigation.controllers.NavigationActivity") == true) {// 检查是否调整到首页
...
//				logger.info("没有登录成功");
	 ...
	 * @throws Exception
	 * */
	public void LonginInput1(String username, String password,String caseNumber) throws Exception {
...
//				this.toastCheck();// 登录失败检查是否存在异常提示框
	...
	public void LonginInput(String username, String password,String caseNumber) throws Exception {
		...
		if (driver.isExitCurActivity("") == true) {
			logger.info("还没有任何账号登录，输入信息，登录中。。。");
			// 检查登录框元素是否存在
//			waitLoginPageLoad(10);
			// 输入账号
...
//		System.out.println("casenber"+caseNumber);
